...
class PastesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create paste" do
    assert_difference("Paste.count") do
      post pastes_url, params: { paste: { private: @paste.private, slug: @paste.slug, title: @paste.title } }
    end
  ...
  test "should update paste" do
    patch paste_url(@paste), params: { paste: { private: @paste.private, slug: @paste.slug, title: @paste.title } }
